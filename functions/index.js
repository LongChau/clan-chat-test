...
// Login to Firebase Console with serviceAccount information.
admin.initializeApp({
...
// This is Firebase Function: execute function.
...
// This is Firebase Function: deploy function.
...
exports.helloWorld  = functions.https.onRequest((request, response) => {
  response.send('Hello mate!!!! Welcome to HELL');
});
